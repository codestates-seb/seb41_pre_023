                ...
                <QuestionsAll>
                    <QuestionMain>
                        ...
                        <MainTopBottom>
                            ...
                            <time
                                dateTime={
                                    new Date(questionsList[1].creation_date)
                                }
                            >
                        ...
                        <QuestionCard>
                            <QuestionContent>
                                How to code invoice bill validation like wise
                                stock system. This will do if customer pay
                                balance invoice amount system will automatically
                                reduce that amount from invoice bill amount and
                                automatically update database data table and
                                update invoice bill balance. How to do this
                                operation using PHP. I want this problem to
                                resolve. how to do that.
                            </QuestionContent>
